...
// My Explanation: we create functions for each number that take an optional operation function as an argument. If the operation is provided, it is called with the number as its argument; otherwise, the number itself is returned. The operation functions (plus, minus, times, dividedBy) return a new function that takes the left operand and performs the specified operation with the right operand.